package com.wxsoft.telereciver.vc.service.call;
...
import com.wxsoft.telereciver.vc.LayoutUtil;
import com.wxsoft.telereciver.vc.service.TupEventHandler;
import com.wxsoft.telereciver.vc.service.TupEventMgr;
import com.wxsoft.telereciver.vc.service.call.data.CallCommandParams;
import com.wxsoft.telereciver.vc.service.call.data.CallSession;
import com.wxsoft.telereciver.vc.service.call.data.OneKeyJoinConfParam;
import com.wxsoft.telereciver.vc.service.call.data.SessionBean;
...
public final class CallService
{
    ...
    private static final int TLS = 1;
...
//        params.setVideo(isVideoCall);
    ...
    {
        tpCllCfgAdVd.setAudioAec(AUDIO_AEC);
    ...
    private void configSip()
    {
        ...
        tupCallCfgSIP.setSipTransMode(TLS);
...
//        tupCallCfgMedia.setMediaSrtpMode(TupCallParam.CALL_E_SRTP_MODE);
