package com.wxsoft.telereciver.vc.service.utils;
...
public final class Tools
{
    ...
    public static Bitmap readBitMap(Context context, int resId)
    {
        ...
        {
            com.wxsoft.telereciver.vc.service.utils.TUPLogUtil.e(TAG, "Progress get an NotFoundException");
        }
        finally
        {
            closeInputStream(is);
    ...
    private static void closeInputStream(InputStream is)
    {
        ...
        {
            com.wxsoft.telereciver.vc.service.utils.TUPLogUtil.e(TAG, "Progress get an IOException");
        }
    }
    ...
    public static String getLocalIp()
    {
        ...
        try
        {
            ...
            if (networkInfo == null)
            {
                com.wxsoft.telereciver.vc.service.utils.TUPLogUtil.d("getLocalIp",
                    ...
                    .hasMoreElements(); )
            {
                        ...
                        .hasMoreElements(); )
                {
                    ...
                    if (!inetAddress.isLoopbackAddress())
                    {
                        ...
                        if (isIPV4Addr(ip))
                        {
                            com.wxsoft.telereciver.vc.service.utils.TUPLogUtil.i("getLocalIp", "ip is " + ip);
                            return ip;
                        }
                    }
                }
        ...
        {
            com.wxsoft.telereciver.vc.service.utils.TUPLogUtil.d("getLocalIp", "SocketException | " + e.toString());
        }
        return ip;
    }
    ...
    private static boolean is3GConnect(Context context)
    {
        ...
        else
        {
            ...
            com.wxsoft.telereciver.vc.service.utils.TUPLogUtil.e(TAG, "info is : " + info);
            if (info != null)
            {
                com.wxsoft.telereciver.vc.service.utils.TUPLogUtil.i(TAG, "info typr is : info.getSubtype() : "
            ...
            if (info == null)
            {
                com.wxsoft.telereciver.vc.service.utils.TUPLogUtil.e(TAG, " MOBILE_TYPE is null  ! ");
                supportType = false;
            }
            else if (info.getType() == 0)
            {
                int subType = info.getSubtype();
                com.wxsoft.telereciver.vc.service.utils.TUPLogUtil.e(TAG, "subType is : " + subType);
                if (subType != 4 && subType != 1 && subType != 2 && subType != 7 && subType != 11)
                {
                    if (is3g4gSubType(subType))
                    {
                        com.wxsoft.telereciver.vc.service.utils.TUPLogUtil.i(TAG, "is 3g / 4g conect");
                        supportType = true;
                    }
                }
                else
                {
                    com.wxsoft.telereciver.vc.service.utils.TUPLogUtil.i(TAG, "is 2g conect");
                    supportType = false;
                }
            }
    ...
    private static boolean isEthernetConnect(Context context)
    {
        ...
        else
        {
            ...
            if (info != null)
            {
                com.wxsoft.telereciver.vc.service.utils.TUPLogUtil.i(TAG, info.toString());
