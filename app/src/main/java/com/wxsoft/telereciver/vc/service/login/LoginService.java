package com.wxsoft.telereciver.vc.service.login;
...
import com.wxsoft.telereciver.vc.service.notify.VCChangePasswordNotify;
...
public class LoginService extends TupLoginNotifyBase
{
    ...
    public int init(TUPInterfaceService tupService)
    {
        ...
        tupLoginManager = TupLoginManager.getIns(this, App.getApplication());
