...
import com.wxsoft.telereciver.vc.service.call.VideoDeviceManager;
import com.wxsoft.telereciver.vc.service.call.data.OneKeyJoinConfParam;
...
import com.wxsoft.telereciver.vc.ui.customview.MenuBarContalPanel;
...
public class CallFragment extends Fragment implements TupNotify
{
    ...
    {
        initMenuItemServer();
        numberAudioTV = getActivity().findViewById(R.id.tv_audio_number);
        hintAudioTV = getActivity().findViewById(R.id.tv_audio_hint);

        audioCallLayout = rootViewGroup.findViewById(R.id.audio_calllayout);

        videoChatLayout = rootViewGroup.findViewById(R.id.video_chatlayout);

        localVideoLayout = rootViewGroup.findViewById(R.id.local_layout);

        remoteVideoView = rootViewGroup.findViewById(R.id.remote_videoview);

        localVideoView = rootViewGroup.findViewById(R.id.local_videoview);
    ...
    private void initMenuItemServer()
    {
        ...
        menuItemServer = new MenuBarContalPanel.MenuItemServer()
        {
            @Override
...
//                startActivity(it);
    ...
    private void handlerMessageCall(Message msg)
    {
        ...
        switch (msg.what)
        {
            ...
            case CallConstants.MSG_CALL_MODIFY_UI:
                ...
                CallConstants.ModifyNoticeType modifyType = (CallConstants.ModifyNoticeType) msg.obj;
     ...
     */
    private void voipCallModify(CallConstants.ModifyNoticeType modifyType)
    {
    ...
    private void voiceToVideo()
    {
        ...
        callActivity.runOnUiThread(new Runnable()
        {
            ...
            public void run()
            {
                ...
                DialogInterface.OnDismissListener dismiss = dialog -> {
    ...
    public void onCallNotify(int code, Object object)
    {
        switch (code)
        {
            case CallConstants.MSG_CALL_UPDATE_UI:
                ...
                break;
            case CallConstants.MSG_CALL_MODIFY_UI:
                CallConstants.ModifyNoticeType noticeType = (CallConstants.ModifyNoticeType) object;
