...
public class CallComingActivity extends Activity
{
    ...
    private Runnable endRunnable = () -> finish();

    private Runnable callRejectTask = () -> {
    ...
    private void initComponent()
    {
        ...
        // Caller name
        incomingNameTextView = findViewById(R.id.incoming_name);

        // Caller ID
        incomingNumberTextView = findViewById(R.id.incoming_number);

        callComingBackground = findViewById(R.id.call_coming_background);
        ImageView callComingImageHead = findViewById(R.id.img_incoming_head);

        acceptAudioButton = findViewById(R.id.callaccept);
        acceptVideoButton = findViewById(R.id.accept);
        rejectButton = findViewById(R.id.refuse);
