...
public final class VideoDeviceManager
{
    ...
    public VideoCaps initCallVideo()
    {
        ...
        localCallView = ViERenderer.createRenderer(context, true);
        // Gets  remote video view
        remoteCallView = ViERenderer.createRenderer(context, true);

        // Get  remote bfcp view
        remoteBfcpView = ViERenderer.createRenderer(context, true);
        // Get  local bfcp view
        localBfcpView = ViERenderer.createRenderer(context, true);
