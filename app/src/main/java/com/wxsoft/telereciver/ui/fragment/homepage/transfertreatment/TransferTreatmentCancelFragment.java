...
public class TransferTreatmentCancelFragment extends BaseFragment {

    public static void launch(Activity from, String disId) {
        FragmentArgs args = new FragmentArgs();
        args.add(FRAGMENTARGS_KEY_DISEASE_ID, disId);
        FragmentContainerActivity.launch(from, TransferTreatmentCancelFragment.class, args);
    }
    ...
    protected int getLayoutId() {
        return R.layout.fragment_transfertreatment_refuse;
    }
    ...
    private void commit() {
        ...
        ApiFactory.getTransferTreatmentApi().cancel(mClinicId, content)
