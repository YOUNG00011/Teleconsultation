...
public class TransferTreatmentRefuceFragment extends BaseFragment {

    public static void launch(Activity from, String disId) {
        FragmentArgs args = new FragmentArgs();
        args.add(FRAGMENTARGS_KEY_DISEASE_ID, disId);
        FragmentContainerActivity.launch(from, TransferTreatmentRefuceFragment.class, args);
    }
    ...
    private void commit() {
        ...
        ApiFactory.getTransferTreatmentApi().refuse(mClinicId, content)
