...
public class GlideCatchUtil {
    ...
    public String getCacheSize() {
        try {
            return getFormatSize(getFolderSize(new File(App.getApplication().getCacheDir() + "/" + AppConstant.Cache.GLIDE_CATCH_DIR)));
        } catch (Exception e) {
            e.printStackTrace();
            return "获取失败";
        }
    ...
    public boolean cleanCatchDisk() {
        return deleteFolderFile(App.getApplication().getCacheDir() + "/" + AppConstant.Cache.GLIDE_CATCH_DIR, true);
    }
