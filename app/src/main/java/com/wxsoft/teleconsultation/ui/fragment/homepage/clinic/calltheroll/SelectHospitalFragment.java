...
public class SelectHospitalFragment extends BaseFragment {
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK) {
            if (requestCode == SelectDepartmentFragment.REQUEST_SELECT_DEPARTMENT) {
                if (data != null) {
                    Doctor doctor = (Doctor) data.getSerializableExtra(SelectDepartmentFragment.KEY_DOCTOR);
    ...
    private void setupRecyclerView() {
        ...
        mAdapter.setOnItemClickListener(position ->  {
            SelectDepartmentFragment.launch(this, mAdapter.getItem(position), true, true,"Consultation");
        });
