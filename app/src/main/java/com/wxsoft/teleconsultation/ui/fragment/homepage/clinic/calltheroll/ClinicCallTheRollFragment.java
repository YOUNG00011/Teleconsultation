package com.wxsoft.teleconsultation.ui.fragment.homepage.clinic.calltheroll;
 ...
 * 会诊申请
 */
public class ClinicCallTheRollFragment extends BaseFragment {

    public static void launch(Activity from) {
        FragmentContainerActivity.launch(from, ClinicCallTheRollFragment.class, null);
    }

    public static void launch(Activity from, Clinic clinic) {
        FragmentArgs args = new FragmentArgs();
        args.add(FRAGMENT_ARGS_CLINIC, clinic);
        FragmentContainerActivity.launch(from, ClinicCallTheRollFragment.class, args);
    }
    ...
    protected void setupViews(View view, Bundle savedInstanceState) {
        ...
        mGlide = Glide.with(ClinicCallTheRollFragment.this);
    ...
    private void setupPhotoRecyclerView() {
        ...
        mPhotoRecyclerView.setAdapter(mPhotoAdapter = new RecyclerArrayAdapter<Photo>(_mActivity) {
            ...
            public BaseViewHolder OnCreateViewHolder(ViewGroup parent, int viewType) {
                return new ClinicPhotoViewHolder(parent, _mActivity, Glide.with(ClinicCallTheRollFragment.this), 4, localPath -> {
