package com.wxsoft.teleconsultation.ui.widget.listview;
...
public class DropDownListView extends ListView implements OnScrollListener {
    ...
    private void initDropDownStyle() {
        ...
        loading = (ProgressBar) headerLayout.findViewById(R.id.jmui_loading_img);
...
//            drawable.start();
    ...
    private void getAttrs(Context context, AttributeSet attrs) {
        int[] dropDownAttrArray = IdUtil.getResourceDeclareStyleableIntArray(context, "drop_down_list_attr");
