...
public class CloudClincSubmitFragment extends BaseFragment {

    public static void launch(Activity from, String disId) {
        FragmentArgs args = new FragmentArgs();
        args.add(FRAGMENTARGS_KEY_DISEASE_ID, disId);
        FragmentContainerActivity.launch(from, CloudClincSubmitFragment.class, args);
    }
    ...
    private void setupToolbar() {
        ...
        activity.getSupportActionBar().setTitle(R.string.cloud_clinc_submit_title);
    ...
    private void commit() {
        ...
        ApiFactory.getCloudClinicApi().saveSummary(mClinicId, content)
