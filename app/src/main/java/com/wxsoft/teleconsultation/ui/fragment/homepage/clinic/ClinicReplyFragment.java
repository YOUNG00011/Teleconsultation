...
public class ClinicReplyFragment extends BaseFragment {

    public static void launch(Activity from, String clinicId) {
        FragmentArgs args = new FragmentArgs();
        args.add(FRAGMENTARGS_KEY_CLINIC_ID, clinicId);
        FragmentContainerActivity.launch(from, ClinicReplyFragment.class, args);
    }
    ...
    protected int getLayoutId() {
        return R.layout.fragment_clinic_reply;
    }
    ...
    private void setupToolbar() {
        ...
        activity.getSupportActionBar().setTitle(R.string.reply_title);
    ...
    private void commit() {
        ...
        ApiFactory.getClinicManagerApi().saveConsultationFeedback(mClinicId, content, AppContext.getUser().getDoctId(), AppContext.getUser().getName())
