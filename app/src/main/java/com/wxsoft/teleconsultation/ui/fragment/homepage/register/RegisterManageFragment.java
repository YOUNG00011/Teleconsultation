...
public class RegisterManageFragment extends BaseFragment {

    public static void launch(Activity from) {
        FragmentContainerActivity.launch(from, RegisterManageFragment.class, null);
    }
    ...
    private void setupToolbar() {
        ...
        activity.getSupportActionBar().setTitle(R.string.register_manager_title);
        setHasOptionsMenu(true);
    }
    ...
    private class PageAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            return RegisterListFragment.newInstance(position);
        }
