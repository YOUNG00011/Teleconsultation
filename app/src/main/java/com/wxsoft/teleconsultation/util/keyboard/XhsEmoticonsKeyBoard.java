package com.wxsoft.teleconsultation.util.keyboard;
...
import com.wxsoft.teleconsultation.ui.widget.RecordVoiceButton;
import com.wxsoft.teleconsultation.util.keyboard.adpater.PageSetAdapter;
import com.wxsoft.teleconsultation.util.keyboard.data.PageSetEntity;
import com.wxsoft.teleconsultation.util.keyboard.utils.EmoticonsKeyboardUtils;
import com.wxsoft.teleconsultation.util.keyboard.widget.AutoHeightLayout;
import com.wxsoft.teleconsultation.util.keyboard.widget.EmoticonsEditText;
import com.wxsoft.teleconsultation.util.keyboard.widget.EmoticonsFuncView;
import com.wxsoft.teleconsultation.util.keyboard.widget.EmoticonsIndicatorView;
import com.wxsoft.teleconsultation.util.keyboard.widget.EmoticonsToolBarView;
