...
public class ViewUtil {
    ...
    public static int getResId(
        ...
        try {
            ...
            Resources resources = App.getApplication().getPackageManager().getResourcesForApplication(packageName);
    ...
    public static void showMessage(@NonNull String message) {
        if (mToast == null) {
            mToast = Toast.makeText(App.getApplication(), message, Toast.LENGTH_SHORT);
        } else {
    ...
    public static void showMessage(@StringRes int messageId) {
        if (mToast == null) {
            mToast = Toast.makeText(App.getApplication(), messageId, Toast.LENGTH_SHORT);
        } else {
