package com.wxsoft.teleconsultation.vc.service.contacts;
...
import com.wxsoft.teleconsultation.vc.service.notify.LdapNotify;
...
public class ContactService implements TupContactsNotify
{
    ...
    {
        tupContactsManager = TupContactsManager.getIns(App.getApplication(), this);
    ...
    {
        boolean r1 = startLocalContactServer();
        boolean r2 = startCallRecordServer();
        boolean r3 = startFtpContactServer();
        TUPLogUtil.i(TAG, "r1=" + r1 + "-----r2=" + r2 + ",r3=" + r3);
    }
     ...
     * @return the boolean
     */
    public boolean startLocalContactServer()
    {
     ...
     * @return the boolean
     */
    public boolean startCallRecordServer()
    {
     ...
     * @return the boolean
     */
    public boolean startFtpContactServer()
    {
