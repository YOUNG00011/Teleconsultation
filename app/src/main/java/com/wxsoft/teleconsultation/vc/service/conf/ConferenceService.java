...
package com.wxsoft.teleconsultation.vc.service.conf;
...
import com.wxsoft.teleconsultation.vc.service.notify.VCConfCtrlNotify;
import com.wxsoft.teleconsultation.vc.service.notify.VCConfNotify;
...
public class ConferenceService implements TupConfNotify
{
    ...
    {
        tupConfManager = TupConfManager.getIns(ConferenceService.this, App.getApplication());
