package com.wxsoft.teleconsultation.receiver;
...
import com.wxsoft.teleconsultation.entity.SystemMessage;
import com.wxsoft.teleconsultation.ui.activity.HomeActivity;
import com.wxsoft.teleconsultation.ui.activity.SplashActivity;
...
//            Log.d(TAG, "[MyReceiver] onReceive - " + intent.getAction() + ", extras: " + printBundle(bundle));
            ...
            if (JPushInterface.ACTION_REGISTRATION_ID.equals(intent.getAction())) {
                ...
                if (msgType.equals(SystemMessage.ExtendFiled.MSG_TYPE_CLINIC)) {
                    ...
                    if (AppUtil.isAppRunning(context, "com.wxsoft.teleconsultation")) {
                        ClinicDetailActivity.launch(context, clinicId);
                    } else {
                        Intent launchIntent = context.getPackageManager().
                                getLaunchIntentForPackage("com.wxsoft.teleconsultation");
